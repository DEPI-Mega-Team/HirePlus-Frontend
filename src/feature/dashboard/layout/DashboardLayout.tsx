        ...
        <div className={styles['dashboard-layout']}>
            <div className={styles['dashboard-layout-sidebar']}>
                <div className={styles['dashboard-layout-button-list-container']}>
                    ...
                    <div className={styles['dashboard-layout-button-container']}>
                        <NavLink className={({isActive}) => isActive ? `${styles['dashboard-layout-button-active']} ${styles['dashboard-layout-button']}` : styles['dashboard-layout-button']} to="/dashboard/profile">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className={styles['dashboard-layout-sidebar-bottom']}>
                    <h2>Settings</h2>
                    <NavLink className={({ isActive }) => isActive ? `${styles['dashboard-layout-settings-button-active']} ${styles['dashboard-layout-settings-button']}` : styles['dashboard-layout-settings-button']} to='/dashboard/settings'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
